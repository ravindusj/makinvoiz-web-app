  ...
  return (
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between gap-2 sm:gap-0">
        <h2 className="text-lg sm:text-xl font-semibold text-slate-800 min-w-0 flex-1">Quotation Details</h2>
        <Button 
          onClick={handleSave} 
          className="bg-emerald-600 hover:bg-emerald-700 flex-shrink-0 text-sm sm:text-base" 
          disabled={isSaving}
          size="sm"
        >
          {isSaving ? (
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          <div>
            <Label htmlFor="quotationNumber" className="text-sm">Quotation Number</Label>
            <Input
              id="quotationNumber"
          ...
          <div className="space-y-3 sm:space-y-4">
            <div>
              <Label htmlFor="quotationDate" className="text-sm">Quotation Date</Label>
              <Input
                id="quotationDate"
                type="date"
