...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-0 z-[100] flex max-h-screen w-full flex-col p-2 sm:p-4 right-0 md:max-w-[420px]",
      className
    )}
    {...props}
  />
